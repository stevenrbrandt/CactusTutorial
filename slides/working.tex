...
and you can run it  like this ``docker run -it -p 8000:8000 --user 1000 craigwillis/jupyter-et jupyter notebook --port 8000 --ip 0.0.0.0 --no-browser'' That will start jupyter on port 8000.
